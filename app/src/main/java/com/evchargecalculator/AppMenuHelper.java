...
public final class AppMenuHelper {
    ...
    public static void show(Activity activity, View anchor, Listener listener) {
        ...
        popup.setOnMenuItemClickListener(item->{
            if(item.getItemId()==10){activity.startActivity(new Intent(activity,ConfigurationActivity.class));return true;}
    ...
    private static String configurationLabel(Activity a){String l=LanguageManager.getSelectedLanguage(a);if("es".equals(l))return "Configuración";if("fr".equals(l))return "Configuration";if("de".equals(l))return "Einstellungen";if("it".equals(l))return "Impostazioni";if("pt".equals(l))return "Definições";return "Settings";}
}
