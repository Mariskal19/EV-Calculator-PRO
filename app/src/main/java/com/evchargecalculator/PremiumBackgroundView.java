...
public class PremiumBackgroundView extends View {
    ...
    @Override protected void onDraw(Canvas c) {
        ...
        LinearGradient bg=new LinearGradient(0,0,w,h,Color.rgb(5,8,14),Color.rgb(6,18,28),Shader.TileMode.CLAMP); p.setShader(bg); c.drawRect(0,0,w,h,p); p.setShader(null);
        ...
        p.setColor(Color.argb(30,77,225,193)); c.drawCircle(w*.18f,h*.35f,130,p); p.setMaskFilter(null);
        // subtle road / floor
        p.setColor(Color.argb(32,180,205,230)); c.drawRect(0,h*.72f,w,h*.725f,p);
        // premium EV silhouette
        float y=h*.67f, x=w*.55f, cw=w*.42f;
        p.setColor(Color.argb(40,145,180,215));
