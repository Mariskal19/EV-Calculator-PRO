...
public class MainActivity extends Activity {
 ...
 LinearLayout card(){LinearLayout l=new LinearLayout(this);l.setOrientation(LinearLayout.VERTICAL);l.setPadding(dp(18),dp(18),dp(18),dp(18));l.setBackground(bg(dark?cardDark:cardLight,22,1));LinearLayout.LayoutParams lp=new LinearLayout.LayoutParams(-1,-2);lp.setMargins(dp(4),0,dp(4),0);l.setLayoutParams(lp);return l;}
