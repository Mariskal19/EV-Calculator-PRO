...
public class MainActivity extends Activity {
 ...
 void build(){
  ...
  TextView title=tv("EV Calculator",22,Color.WHITE);title.setTypeface(null,1);title.setGravity(Gravity.CENTER_VERTICAL);title.setShadowLayer(dp(4),0,dp(2),Color.argb(90,0,0,0));FrameLayout.LayoutParams tp=new FrameLayout.LayoutParams(-2,dp(48));tp.gravity=Gravity.TOP|Gravity.START;tp.leftMargin=dp(18);tp.topMargin=dp(8);hero.addView(title,tp);
