...
public class MainActivity extends Activity {
 ...
 void build(){
  ...
  costR=tv("0,00 € (0,0 kWh)",15,sub());costR.setGravity(Gravity.CENTER_VERTICAL|Gravity.END);costR.setSingleLine(true);costR.setIncludeFontPadding(false);LinearLayout.LayoutParams costValueLp=new LinearLayout.LayoutParams(0,dp(20),1);costValueLp.setMargins(0,0,dp(8),0);costRow.addView(costR,costValueLp);c3.addView(costRow,costRowLp);
