...
public class MainActivity extends Activity {
 ...
 int blue=Color.rgb(41,110,245), green=Color.rgb(54,199,170), white=Color.rgb(23,35,54), secondary=Color.rgb(101,119,146), cardLight=Color.argb(244,255,255,255), cardDark=Color.argb(218,17,25,39), surfaceLight=Color.rgb(245,249,255), borderLight=Color.rgb(218,228,240), headerLight=Color.argb(250,255,255,255), headerDark=Color.argb(185,16,24,37);
