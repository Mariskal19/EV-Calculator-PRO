...
public class MainActivity extends Activity {
 ...
 void build(){
  ...
  sceneHeader.setTranslationY(-dp(50));
  hero.addView(sceneHeader,new FrameLayout.LayoutParams(-1,-1));
  View topFade=new View(this);topFade.setBackground(new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM, new int[]{Color.argb(160,0,0,0), Color.argb(20,0,0,0), Color.argb(0,0,0,0)}));hero.addView(topFade,new FrameLayout.LayoutParams(-1,dp(120),Gravity.TOP));
  TextView title=tv("EV Charge Calculator",22,Color.WHITE);title.setTypeface(null,1);title.setGravity(Gravity.CENTER);title.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);title.setShadowLayer(dp(4),0,dp(2),Color.argb(90,0,0,0));FrameLayout.LayoutParams tp=new FrameLayout.LayoutParams(-1,dp(48));tp.gravity=Gravity.TOP|Gravity.CENTER_HORIZONTAL;tp.leftMargin=dp(52);tp.rightMargin=dp(52);tp.topMargin=dp(8);hero.addView(title,tp);
  themeButton=tv(dark?"☀":"☾",20,Color.WHITE);themeButton.setGravity(Gravity.CENTER);themeButton.setTextColor(Color.WHITE);themeButton.setContentDescription("Cambiar tema");themeButton.setShadowLayer(dp(4),0,dp(2),Color.argb(90,0,0,0));themeButton.setBackground(bg(Color.argb(120,12,22,33),12,1));themeButton.setPadding(dp(6),dp(4),dp(6),dp(4));themeButton.setOnClickListener(v->toggleTheme());FrameLayout.LayoutParams ip=new FrameLayout.LayoutParams(dp(40),dp(40),Gravity.TOP|Gravity.END);ip.rightMargin=dp(18);ip.topMargin=dp(8);hero.addView(themeButton,ip);
  root.addView(hero);
