...
public class ConfigurationActivity extends Activity {
    ...
    @Override public void onCreate(Bundle b){super.onCreate(b);prefs=getSharedPreferences(PREFS,MODE_PRIVATE);if(prefs.contains(KEY_DARK_THEME)){dark=prefs.getBoolean(KEY_DARK_THEME,false);}else{dark=(getResources().getConfiguration().uiMode&0x30)==0x20;prefs.edit().putBoolean(KEY_DARK_THEME,dark).putString(KEY_THEME_MODE,dark?"dark":"light").apply();}build();}
