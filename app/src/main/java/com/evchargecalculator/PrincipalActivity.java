...
public class PrincipalActivity extends Activity {
    ...
    private void build(){
        ...
        ScrollView scroll=new ScrollView(this);scroll.setFillViewport(true);scroll.setClipToPadding(false);LinearLayout root=new LinearLayout(this);root.setOrientation(LinearLayout.VERTICAL);root.setPadding(0,0,0,dp(16));root.setTag(0);scroll.addView(root);frame.addView(scroll,new FrameLayout.LayoutParams(-1,-1));setContentView(frame);
        // Keep the visual top margin fixed at 36dp. The root tag prevents the global
        // system-bar handler from adding a second theme-dependent top padding.
