...
public class PrincipalActivity extends Activity {
    ...
    @Override protected void onResume(){super.onResume();SharedPreferences p=getSharedPreferences(PREFS,MODE_PRIVATE);if(p.contains(KEY_DARK_THEME)){boolean d=p.getBoolean(KEY_DARK_THEME,false);if(d!=dark){dark=d;recreate();}}}
    private void build(){
        ...
        root.addView(card);
        // Footer stays at the same fixed bottom position as before the second calculator was added.
