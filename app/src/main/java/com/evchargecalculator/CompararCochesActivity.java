...
public class CompararCochesActivity extends Activity {
    ...
    private void build() {
        ...
        root.addView(hero);
        ScrollView scroll=new ScrollView(this); scroll.setFillViewport(true); scroll.setClipToPadding(false); scroll.setTranslationY(-dp(26)); LinearLayout content=new LinearLayout(this); content.setOrientation(LinearLayout.VERTICAL); content.setPadding(dp(14),dp(14),dp(14),dp(12));
