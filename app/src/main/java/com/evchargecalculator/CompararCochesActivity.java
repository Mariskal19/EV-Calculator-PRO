...
public class CompararCochesActivity extends Activity {
    ...
    private void build() {
        ...
        HorizontalScrollView carsScroll=new HorizontalScrollView(this); carsScroll.setHorizontalScrollBarEnabled(false); carsScroll.setClipToPadding(false); carsScroll.setPadding(0,dp(12),0,dp(4)); LinearLayout.LayoutParams carsScrollLp=new LinearLayout.LayoutParams(-1,-2); carsScrollLp.topMargin=dp(26); carsRow=new LinearLayout(this); carsRow.setOrientation(LinearLayout.HORIZONTAL); carsRow.setGravity(Gravity.TOP); carsScroll.addView(carsRow,new HorizontalScrollView.LayoutParams(-2,-2)); content.addView(carsScroll,carsScrollLp);
