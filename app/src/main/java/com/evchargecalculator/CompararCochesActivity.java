...
public class CompararCochesActivity extends Activity {
    ...
    private LinearLayout carsRow, table;
    ...
    private GradientDrawable strokeBg(int color,float r){GradientDrawable g=bg(color,r);g.setStroke(dp(1),dark?Color.rgb(38,59,85):Color.rgb(217,228,241));return g;}
