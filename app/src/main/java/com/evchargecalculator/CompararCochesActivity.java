...
public class CompararCochesActivity extends BaseNavigationActivity {
  ...
  protected int getBottomNavigationIndex() {
    ...
    private void build() {
        ...
        ImageView heroImage = new ImageView(this); heroImage.setImageResource(R.drawable.cabecera_tema_claro); heroImage.setScaleType(ImageView.ScaleType.CENTER_CROP); heroImage.setAdjustViewBounds(false); heroImage.setTranslationY(-dp(10)); hero.addView(heroImage, new FrameLayout.LayoutParams(-1,-1));
