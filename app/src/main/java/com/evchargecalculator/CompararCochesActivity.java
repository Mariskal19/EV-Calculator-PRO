...
public class CompararCochesActivity extends Activity {
    ...
    private void build() {
        ...
        ImageView heroImage = new ImageView(this); heroImage.setScaleType(ImageView.ScaleType.CENTER_CROP); heroImage.setImageResource(R.drawable.cabecera_tema_claro);
        heroImage.setColorFilter(dark ? 0x88000000 : Color.TRANSPARENT, android.graphics.PorterDuff.Mode.SRC_OVER); hero.addView(heroImage, new FrameLayout.LayoutParams(-1,-1));
