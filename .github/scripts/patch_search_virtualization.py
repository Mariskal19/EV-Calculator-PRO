...
# The intro card overlaps the hero by 26dp. The immediate content container
# must not clip that overlap at its top edge.
...
if 'content.setClipChildren(false);' not in s3 and marker in s3:
    ...
    print("Compare intro card top clipping fixed.")
